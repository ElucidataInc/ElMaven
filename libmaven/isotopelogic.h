...
public:
	IsotopeLogic();
	void computeIsotopes(string f, pair<massAccType,double> pr, double maxNaturalAbundanceErr, bool C13Labeled, bool N15Labeled, 
...
private:
	float getIsotopeIntensity(float mz, pair<massAccType,double> pr);
};
