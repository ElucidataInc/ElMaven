...
namespace Pillow
{
	...
	public:
		...
		void abort(); // Stop any active request and break current server connection. If there was an active request, finished() will be Q_EMITted and the error will be set to AbortedError.
