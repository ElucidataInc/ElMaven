...
class Compound
{
    ...
    /**
     *@param -  srmId will hold filterLine string from mzxml file which
     *represent type of mass spec and ionization is used and other info as well
     */
    string _srmId;
    ...
    public:
    enum class Type { MS1, MRM, MS2, UNKNOWN };

    enum class IonizationMode { Positive, Negative, Neutral };
    ...
    /**
     *@brief  -   utility function to compare compound by name for sorting
     *purpose
     */
    ...
    /**
     *@brief  -  utility function to compare compound by formula for sorting
     *purpose
     */
    static bool compFormula(const Compound* a, const Compound* b)
    {
        return (a->_formula < b->_formula);
    }
};
