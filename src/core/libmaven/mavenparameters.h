...
class MavenParameters
{
     ...
     * do no group peaks that are greater than differ more than X in retention
     * time
     */
    ...
    int alignMaxIterations;  // TODO: Sahil - Kiran, Added while merging
                             // mainwindow
    int alignPolynomialDegree;  // TODO: Sahil - Kiran, Added while merging
                                // mainwindow
