...
{
    public:
    enum class ChildFilterType { Isotope, BarplotIsotope, Adduct };
    ...
    /**
     * [apply peak selection filters to group; if x percentage of peaks in the
     * group are above the user input threshold for a parameter, do not reject
     * the group]
