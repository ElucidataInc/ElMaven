...
{
    return (mzmin == b.mzmin && mzmax == b.mzmax && rtmin == b.rtmin
            && rtmax == b.rtmax && ionCount == b.ionCount
            && compound == b.compound && adduct == b.adduct
            && isotope == b.isotope && srmId == b.srmId && mz == b.mz
            && rt == b.rt);
}

bool mzSlice::calculateMzMinMax(MassCutoff* compoundMassCutoffWindow,
                                int charge)
{
...
void mzSlice::calculateRTMinMax(bool matchRtFlag, float compoundRTWindow)
{
    ...
    // possible
    if (matchRtFlag && this->compound != nullptr
