...
class mzSlice
{
    public:
    /**
     * @brief Average rt of a mzSlice. Zero in case mzSlice is based on
     * filterline or constructor is empty
     */
    float rt;

    /**
     * @brief Average mz of a mzSlice. Zero in case mzSlice is based on
     * filterline or constructor is empty
     */
    float mz;
     ...
     * and mass accuracy (in ppm). Compound m/z is being calculated using
     * formula or taken from Compound class if formula is not present
     ...
     * @param matchRtFlag This flag is true if retention time in compound
     * database is being used
     * @param compoundRTWindow Retention time window for matching Rt from
     * compound database
     */
