...
void GraphWidgetScene::mouseMoveEvent ( QGraphicsSceneMouseEvent * mouseEvent ) {
...
void GraphWidgetScene::mouseReleaseEvent ( QGraphicsSceneMouseEvent * mouseEvent ) {
...
{
    _myscene = new GraphWidgetScene(this);
