 ...
 * \ingroup mzroll
 *
 * \brief Class for BarPlot.
 *
 * This class is used for BarPlot.
 *
 * \author Euigen
...
public:
	...
	void switchQValue();
	void clear();
	void showSampleNames(bool flag) {
		_showSampleNames = flag;
	}
	void showIntensityText(bool flag) {
		_showIntensityText = flag;
	}
	void showQValueType(bool flag) {
		_showQValueType = flag;
	}
