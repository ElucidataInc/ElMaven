...
public:
    ...
    void setupUi(QDialog *CompareSamplesDialog)
    {
        if (CompareSamplesDialog->objectName().isEmpty())
            CompareSamplesDialog->setObjectName(QString::fromUtf8("CompareSamplesDialog"));
        ...
        minFoldDiff->setObjectName(QString::fromUtf8("minFoldDiff"));
        minFoldDiff->setValue(1);
        ...
        minIntensity->setObjectName(QString::fromUtf8("minIntensity"));
        ...
        minPValue->setObjectName(QString::fromUtf8("minPValue"));
        ...
        missingValue->setObjectName(QString::fromUtf8("missingValue"));
        ...
        minGoodSamples->setObjectName(QString::fromUtf8("minGoodSamples"));
        ...
        filelist1->setObjectName(QString::fromUtf8("filelist1"));
        ...
        fileCount1->setObjectName(QString::fromUtf8("fileCount1"));

        gridLayout_2->addWidget(fileCount1, 3, 0, 1, 1);

        fileCount2 = new QLabel(frame);
        fileCount2->setObjectName(QString::fromUtf8("fileCount2"));

        gridLayout_2->addWidget(fileCount2, 3, 2, 1, 1);

        filelist2 = new QListWidget(frame);
        filelist2->setObjectName(QString::fromUtf8("filelist2"));
    ...
    {
        CompareSamplesDialog->setWindowTitle(QApplication::translate("CompareSamplesDialog", "Compare Samples", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("CompareSamplesDialog", "p. value", 0, QApplication::UnicodeUTF8));
        compareButton->setText(QApplication::translate("CompareSamplesDialog", "Compare Sets", 0, QApplication::UnicodeUTF8));
        resetButton->setText(QApplication::translate("CompareSamplesDialog", "Reset", 0, QApplication::UnicodeUTF8));
        cancelButton->setText(QApplication::translate("CompareSamplesDialog", "Done", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("CompareSamplesDialog", "Min. Fold Diff", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("CompareSamplesDialog", "Min. Intensity", 0, QApplication::UnicodeUTF8));
        correctionBox->clear();
        correctionBox->insertItems(0, QStringList()
         << QApplication::translate("CompareSamplesDialog", "No Correction", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("CompareSamplesDialog", "Bonferroni", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("CompareSamplesDialog", "Holms", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("CompareSamplesDialog", "Benjamini", 0, QApplication::UnicodeUTF8)
        );
        label_3->setText(QApplication::translate("CompareSamplesDialog", "Set Missing Values", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("CompareSamplesDialog", "FDR Correction", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("CompareSamplesDialog", "Min. Good Samples", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("CompareSamplesDialog", "Set 2", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("CompareSamplesDialog", "Set 1", 0, QApplication::UnicodeUTF8));
        fileCount1->setText(QApplication::translate("CompareSamplesDialog", "0 samples selected", 0, QApplication::UnicodeUTF8));
        fileCount2->setText(QApplication::translate("CompareSamplesDialog", "0 samples selected", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
